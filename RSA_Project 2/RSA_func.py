...
def extendEuclidean(e: int, phi: int):
    ...
    d, k = 0, 0             # you can delete this line if necessary
...
def encryptInt(message: int, publicKey: int, n: int):
    ...
    """ WRITE YOUR CODE BELOW """
    encryptMsg = message    # you can delete this line if necessary
...
def decryptInt(message: int, privateKey: int, n: int):
    ...
    decryptMsg = message    # you can delete this line if necessary
